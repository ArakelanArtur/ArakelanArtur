...
Создай новый репозиторий, имя которого совпадает с твоим логином (например, если твой ник IvanIvanov, репозиторий должен называться IvanIvanov).

GitHub предложит тебе создать "особенный" репозиторий (Special Repository).

Создай в нем файл README.md и вставь туда текст выше.

Не забудь заменить [Твое Имя], контакты и ТВОЙ_НИК в ссылке на статистику на свои реальные данные.

Если хочешь добавить что-то специфическое (например, проекты, над которыми сейчас работаешь), просто напиши, и я помогу дополнить!
